<template>
	...
	<view class="">
		...
		<!-- 搜索框 -->
		<view class="search-cont px-3" :style="theme.bgColor">
			<view class="position-relative">
				<input @confirm="search(searchVal)" style="padding-left: 66rpx;box-sizing: border-box;" confirm-type="search"
				 v-model="searchVal" placeholder="请输入关键字" />
