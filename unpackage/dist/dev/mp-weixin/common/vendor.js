...
var _vodClassify = _interopRequireDefault(__webpack_require__(/*! @/store/modules/vod-classify.js */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 8));var api = _interopRequireWildcard(__webpack_require__(/*! @/common/lib/api.js */ 19));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _getRequireWildcardCache() {if (typeof WeakMap !== "function") return null;var cache = new WeakMap();_getRequireWildcardCache = function _getRequireWildcardCache() {return cache;};return cache;}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;}if (obj === null || typeof obj !== "object" && typeof obj !== "function") {return { default: obj };}var cache = _getRequireWildcardCache();if (cache && cache.has(obj)) {return cache.get(obj);}var newObj = {};var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor;for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null;if (desc && (desc.get || desc.set)) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}newObj.default = obj;if (cache) {cache.set(obj, newObj);}return newObj;}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
var app = getApp();var _default =
{
  ...
  mutations: {
    ...
    initUser: function initUser(state) {
      var db = _vue.default.prototype.sub.db;
    ...
    callack) {var commit = _ref.commit,state = _ref.state;
      ...
      wx.getUserProfile({
        ...
        success: function success(infoRes) {
          uni.login({
            provider: 'weixin',
            success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(loginRes) {var db, info, userInfo;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                        db = _vue.default.prototype.sub.db;
                        ...
                        db.collection('userList').get().then(function (res) {
                          ...
                          if (userList.length <= 0) {
                            ...
                            then(function (res) {
                              var _id = res._id;
                              db.collection('userList').doc(_id).get().then(function (res) {
                                // res.data 包含该记录的数据
...
exports.getvodClassify = getvodClassify;var getvodClassifyList = function getvodClassifyList(options, isJia) {
  return _request.default.get('/j/new_search_subjects', options, isJia);
};
