...
var _videoList = _interopRequireDefault(__webpack_require__(/*! ./pages/common/video-list.vue */ 71));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _video_list_vue_vue_type_template_id_715d042b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./video-list.vue?vue&type=template&id=715d042b& */ 72);
/* harmony import */ var _video_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./video-list.vue?vue&type=script&lang=js& */ 74);
...

{
  ...
  methods: {
    // 获取搜索视频列表
    searchOvd: function searchOvd() {var _arguments = arguments,_this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var curPage, pageSize, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:curPage = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 1;pageSize = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : 15;_context.next = 4;return (
                  _this.$api.getSearch({
                    keyword: _this.item.searchVal,
                    curPage: curPage,
                    pageSize: pageSize }));case 4:data = _context.sent;

                // 加载更多
                _this.$U.moreLoad.call(_this, data.result) ? _this.videoList = data.result : '';case 6:case "end":return _context.stop();}}}, _callee);}))();
    },
    // 获取热门视频列表
    getHotListOvd: function getHotListOvd() {var _arguments2 = arguments,_this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var startPage, endPage, data;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:startPage = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : 1;endPage = _arguments2.length > 1 && _arguments2[1] !== undefined ? _arguments2[1] : 15;_context2.next = 4;return (
                  _this2.$api.indexClassify({
                    vod_level: _this2.item.type_id,
                    startPage: (startPage - 1) * endPage,
                    endPage: endPage,
                    more: 1 }));case 4:data = _context2.sent;

                // 加载更多
                _this2.$U.moreLoad.call(_this2, data.data) ? _this2.videoList = data.data : '';case 6:case "end":return _context2.stop();}}}, _callee2);}))();
